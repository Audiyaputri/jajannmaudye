<?php
include "koneksi.php";
$data = mysqli_query($koneksi, "SELECT * FROM jajanan WHERE jenis='Manis'");
if (!$data) {
...
/* ==== CARD PRODUK (DISAMAKAN DENGAN BEST SELLER) ==== */
.card-wrapper {
    flex-grow: 1;
    padding: 40px;
    display: flex;
...
<div class="content-container">
    ...
    <!-- Navigasi Sama Dengan Halaman Utama -->
    <aside class="kolom1">
    ...
    <div class="card-wrapper">
        ...
        <div class="card">
            <img src="uploads/<?php echo $row['img']; ?>" alt="<?php echo $row['nama']; ?>">
